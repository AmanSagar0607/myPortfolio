...
const Hero = () => {
  return (
    <section className={`relative w-full h-screen mx-auto`}>
      <div
        className={`absolute inset-0 lg:top-[150px] md:top-[150px] top-[85px] max-w-7xl mx-auto ${styles.paddingX} flex flex-row items-start gap-5`}
      >
        ...
        <div className="md:flex justify-between items-center w-full">
          <div className="flex flex-col">
            ...
            <p className={`${styles.heroSubText} mt-2 text-white-100`}>
              I develop visually attractive web user{" "}
              <br className="sm:block hidden" />
              interfaces and Web Apllications.{" "}
              <br className="sm:block hidden" />
              I bring expertise in UI/UX principles
              <br className="sm:block hidden" />& frameworks such as React and
              Nextjs.
            </p>
            ...
            <a
              ...
              className="mt-4 border-[1.5px] bg-[#6a63f5bd] text-center box-shadow text-white py-3 px-4 md:w-[30%] lg:w-[30%] w-[50%] rounded-xl hover:border-gray-100 hover:bg-[#635bfc] border-[#665ef7] transition duration-300 ease-in-out transform hover:scale-102 flex items-center justify-center"
            >
