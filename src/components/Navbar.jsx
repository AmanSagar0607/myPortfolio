    ...
    >
      <div className="w-full flex justify-between items-center max-w-6xl mx-auto">
        ...
        >
          ...
          <p className="text-white text-[20px] font-semibold cursor-pointer flex -p-0.5">
            man
          </p>
        </Link>
        ...
        <ul className="list-none hidden xl:flex flex-row gap-10">
          ...
          <Link
            to="https://drive.google.com/file/d/1vYu8NdMTNGQWbCPZLzw4jYwCGR_tuNn2/view?usp=sharing"
